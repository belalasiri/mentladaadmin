...
const EditPlan = ({route, navigation}) => {
  ...
  const handleValueChange = itemValue =>
    setPlansData({...plansData, planType: itemValue});
  ...
  const updatePlan = async () => {
    firestore()
      ...
      .doc(route.params.id)
      .update({
        planPrice: plansData.planPrice,
        planType: plansData.planType,
        planFeatures: plansData.planFeatures,
    ...
    await firestore()
      ...
      .then(documentSnapshot => {
        if (documentSnapshot.exists) {
          ...
          setPlansData(documentSnapshot.data());
          setLoading(false);
        }
      });
  };
  ...
  return (
    <SafeAreaView
      ...
      <Header
        name={`Edit the ${plansData.planType} plan`}
      ...
      <View
        ...
        <View
          ...
          <Picker
            ...
            style={[
              ...
              {color: plansData.planType ? COLORS.secondary : '#c19ce9'},
            ]}
            selectedValue={plansData ? plansData.planType : ''}
        ...
        <View style={styles.newPostContainer}>
          <View style={styles.textInputContainer}>
            <TextInput
              ...
              multiline
              value={plansData ? plansData.planFeatures : ''}
              onChangeText={text =>
                setPlansData({...plansData, planFeatures: text})
              }
        ...
        <View
          ...
          <TextInput
            ...
            value={plansData ? plansData.planPrice : ''}
            onChangeText={txt => setPlansData({...plansData, planPrice: txt})}
            style={{
              flex: 1,
              ...FONTS.body4,
